...
class Firewall:
    ...
    def __init__(self):
        self.regr = None
        print("Firewall model, training train_model")

    def get_regr_model(self):
        return self.regr

    def train_module(self):
        df = pd.read_csv('fw_data_trace.csv', header=None, names=['num_packets', 'payload_size', 'get_time', 'exec_time'])
        df.head()
    ...
    def predict(self, attr1, attr2):
        ...
        print("[Firewall Latency Prediction] Prediction : {0}".format(Y_predict[0][0]))
